...
def graph(type,h,dtfilter,req,expression,mtype,maw,pct,mname,learn):
    ...
    if type =='Moving Std':
        print "type",type
        j,y = g.getMSTF(keys,dtfilter,expression)
        ctype=('StockChart',json.dumps(y))
    elif type =='Time Series':
        print type,keys
        j,y = g.getRegular(keys,dtfilter,expression,False)
        ctype=('StockChart',json.dumps(y))
    elif type =='XY':
        print type,keys
        ...
        print type,keys
        j,y = g.getCorrelations(keys,dtfilter,expression)
        ctype=('StockChart',json.dumps(y))
        ...
        print type,keys
        j,_ = g.getRegular(keys,dtfilter,expression,False)
        ctype=('Table',)        
    else:
        return {}
