...
cnx = sqlite3.connect(CONNEXION_PATH+"/databases/localdb")
data_cnx=sqlite3.connect(CONNEXION_PATH+"/databases/db")
...
class Connect(object):
    ...
    def existsData(self,sensorid):
        e = sql.table_exists('sensor_'+  str(id),data_cnx,'sqlite')
        return e
