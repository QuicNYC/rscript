...
var Dajaxice = {
    ...
    uploadPython: function(callback_function, argv, custom_settings){
        return Dajaxice.call('building.uploadPython', 'POST', callback_function, argv, custom_settings);
    },

    getGraph: function(callback_function, argv, custom_settings){
        return Dajaxice.call('building.getGraph', 'POST', callback_function, argv, custom_settings);
    },

    getConfList: function(callback_function, argv, custom_settings){
        return Dajaxice.call('building.getConfList', 'POST', callback_function, argv, custom_settings);
    },

    getSensorTree: function(callback_function, argv, custom_settings){
        return Dajaxice.call('building.getSensorTree', 'POST', callback_function, argv, custom_settings);
    },

    getFloorList: function(callback_function, argv, custom_settings){
        return Dajaxice.call('building.getFloorList', 'POST', callback_function, argv, custom_settings);
    },

    getSensorList: function(callback_function, argv, custom_settings){
        return Dajaxice.call('building.getSensorList', 'POST', callback_function, argv, custom_settings);
    },

    getConf: function(callback_function, argv, custom_settings){
        return Dajaxice.call('building.getConf', 'POST', callback_function, argv, custom_settings);
    },

    saveConf: function(callback_function, argv, custom_settings){
        return Dajaxice.call('building.saveConf', 'POST', callback_function, argv, custom_settings);
    }
